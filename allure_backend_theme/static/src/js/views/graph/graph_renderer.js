        ...
        _render: function () {
            ...
            if (!_.contains(CHART_TYPES, this.state.mode)) {
                ...
                self._rpc({
                    ...
                    if (!(results[0].mode === 'night_mode_on')) {
                        ...
                        var allcolor = ["#128193", "#78a0ff", "#00b3e5", "#ca0c05", "#00aa00", "#e47e01", "#005ba9", "#717171"]
                        _.each(allcolor, function(hexColor) {
                            self.theme_colors.push(invertColor(hexColor));
                        });
                        self._renderGraph();
                    }
                });
