{
    'name': "ICONOFFICE - Ksolves Theme Base",
    ...
    'category': 'tools',
    'version': '2.0.7',
    'depends': ['base', 'website_blog', 'sale_management', 'website_sale', 'website_theme_install', 'rating', 'product_brand'],
