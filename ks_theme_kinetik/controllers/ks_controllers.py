...
# *******************************************
    ...
    def cart_update(self, product_id, add_qty=1, set_qty=0, **kw):
        ...
        elif 'product_template_id' in kw and 'my_cart' in kw:
...
# **********************
    ...
    def get_combination_info_website(self, product_template_id, product_id, combination, add_qty, **kw):
        ...
        if request.registry.models.get('ks_theme_kinetik.ks_settings', False):
            ...
            order = 'website_sequence desc'
        orders = 'is_published desc, %s, id desc' % order
        product_list = request.env['product.template'].search([], order=orders).mapped('id')
        ...
        res.update({
            ...
            'prev_prod_url': "/shop/product/%s" % previous_id if previous_id else None,
            'next_prod_url': "/shop/product/%s" % next_id if next_id else None,
...
# *********************************************
    ...
    def product(self, product, category='', search='', **kwargs):
        ...
        values.qcontext.update({
            ...
            "seconds": seconds,
            'ks_brand_icon':product.product_brand_id.id,
            'ks_brand_description':product.product_brand_id.description,
        })
